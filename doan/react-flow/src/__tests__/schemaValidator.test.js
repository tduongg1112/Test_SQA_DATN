...
describe('A. Core Validator: schemaValidator.js', () => {
    ...
    // TC_FE_VAL_05 | Create/Update Table | validateTableName | Starts with number
    test('TC_FE_VAL_05: validateTableName should reject names starting with a number', () => {
    ...
    // TC_FE_VAL_06 | Create/Update Table | validateTableName | Exceeds max length limit
    test('TC_FE_VAL_06: validateTableName should reject names exceeding max length limit', () => {
    ...
    // TC_FE_VAL_07 | Create/Update Table | validateTableName | Duplicate table name
    test('TC_FE_VAL_07: validateTableName should reject duplicate table names', () => {
    ...
    // TC_FE_VAL_08 | Create/Update Column | validateColumnName | Valid column name
    test('TC_FE_VAL_08: validateColumnName should accept valid column name', () => {
        const inputColName = "id";
        const result = validateColumnName(inputColName);
        expect(result.isValid).toBe(true);
    });

    // TC_FE_VAL_09 | Create/Update Column | validateColumnName | Empty column name
    test('TC_FE_VAL_09: validateColumnName should reject empty name', () => {
        const inputColName = "";
        const result = validateColumnName(inputColName);
        expect(result.isValid).toBe(false);
    ...
    // TC_FE_VAL_10 | Create/Update Column | validateColumnName | Duplicate column in same table
    test('TC_FE_VAL_10: validateColumnName should reject duplicate columns in the same table', () => {
    ...
    // TC_FE_VAL_11 | Connect Canvas Edges | validateRelationship | Valid FK to PK
    test('TC_FE_VAL_11: validateRelationship should accept valid FK to PK connection', () => {
    ...
    // TC_FE_VAL_12 | Connect Canvas Edges | validateRelationship | Data type mismatch
    test('TC_FE_VAL_12: validateRelationship should reject mismatched data types', () => {
